...
public class TestActionApiConfiguration extends BaseActionApiConfiguration<IDirectAction> {

    private List<Class<?>> classActionList;

    public void setClassActionList(List<Class<?>> classActionList) {
	this.classActionList = classActionList;
    }

    @Override
    protected List<Class<?>> getListActionClass() {
	return classActionList;
    }
}