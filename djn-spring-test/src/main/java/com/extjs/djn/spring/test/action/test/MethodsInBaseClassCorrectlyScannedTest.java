...
@Component
public class MethodsInBaseClassCorrectlyScannedTest extends com.softwarementors.extjs.djn.test.MethodsInBaseClassCorrectlyScannedTest
	implements ITestDirectAction {
